...
func (_u *UserUpdate) AddFavouriteIDs(ids ...uuid.UUID) *UserUpdate {
	_u.mutation.AddFavouriteIDs(ids...)
	return _u
}

// AddFavourites adds the "favourites" edges to the Favourite entity.
func (_u *UserUpdate) AddFavourites(v ...*Favourite) *UserUpdate {
...
// AddFavouriteIDs adds the "favourites" edge to the Favourite entity by IDs.
func (_u *UserUpdateOne) AddFavouriteIDs(ids ...uuid.UUID) *UserUpdateOne {
	_u.mutation.AddFavouriteIDs(ids...)
	return _u
}

// AddFavourites adds the "favourites" edges to the Favourite entity.
func (_u *UserUpdateOne) AddFavourites(v ...*Favourite) *UserUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearFavourites clears all "favourites" edges to the Favourite entity.
func (_u *UserUpdateOne) ClearFavourites() *UserUpdateOne {
	_u.mutation.ClearFavourites()
	return _u
}

// RemoveFavouriteIDs removes the "favourites" edge to Favourite entities by IDs.
func (_u *UserUpdateOne) RemoveFavouriteIDs(ids ...uuid.UUID) *UserUpdateOne {
	_u.mutation.RemoveFavouriteIDs(ids...)
	return _u
}

// RemoveFavourites removes "favourites" edges to Favourite entities.
func (_u *UserUpdateOne) RemoveFavourites(v ...*Favourite) *UserUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
