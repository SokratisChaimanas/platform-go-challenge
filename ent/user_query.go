...
func (_q *UserQuery) QueryFavourites() *FavouriteQuery {
...
func (_q *UserQuery) WithFavourites(opts ...func(*FavouriteQuery)) *UserQuery {
	query := (&FavouriteClient{config: _q.config}).Query()
...
func (_q *UserQuery) loadFavourites(ctx context.Context, query *FavouriteQuery, nodes []*User, init func(*User), assign func(*User, *Favourite)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(favourite.FieldUserID)
	}
